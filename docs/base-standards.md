...
- [Pull requests](./pull-requests.md) — How to open a pull request. Follow it before `gh pr create`.
...
- **Pull requests**: Follow [pull-requests.md](./pull-requests.md) before opening one.
